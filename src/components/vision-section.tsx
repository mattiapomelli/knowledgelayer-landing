...
export const VisionSection = () => {
  return (
    <section className="bg-accent text-base-content">
      <Container className="flex flex-col items-center gap-20 py-20 md:flex-row">
        <div>
          <Image
            src="/network.svg"
            width="546px"
        ...
        <div className="flex flex-col gap-6 text-center md:text-left">
          ...
          <p className="max-w-[28rem] text-lg text-base-content-neutral">
            Education is the key to unlocking human potential. KnowledgeLayer
            aims to create a network of individuals who are passionate about
