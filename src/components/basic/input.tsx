...
const variantClassname = {
  solid:
    "bg-base-300 drop-shadow-default border-primary-content border-2 hover:border-primary-content",
      ...
      >
        ...
        <input
          ...
          className={cx(
            ...
            "focus:outline-none focus:ring-none focus-within:outline-none",
            "w-full",
